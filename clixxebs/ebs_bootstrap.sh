...
#extend logical volume to 2G
sudo lvextend -L +2G /dev/mapper/stack_vg-Lv_u01
sudo lvextend -L +2G /dev/mapper/stack_vg-Lv_u02
sudo lvextend -L +2G /dev/mapper/stack_vg-Lv_u03

#resize the files system
